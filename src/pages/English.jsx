  ...
  return (
    <div className="App" ref={ref}>
      <div className='fixed z-40 w-full'>
        <div className=" mt-4 headertop lg:px-9 px-2 justify-center ">
              <div className="p-4 w-full header lg:rounded-[30px] rounded-[25px] border-2 border-opacity-10 items-center flex flex-row bg-pine bg-opacity-40 backdrop-blur-lg border-white">
                  ...
                  <div className='ml-auto flex flex-row lg:space-x-8 text-sm lg:text-base lg:px-10 space-x-3'>
      ...
      <section id="home" className='first space-y-32'>
        <h1 className='motto lg:px-24 text-center font-reckless text-4xl lg:text-[4rem] text-gold'>Care. Respect. Safety.</h1>
        <img src='hero.webp'/>
      </section>
      <section className='space-y-10 gallery'>
        <h1 className='test1 lg:px-24 px-6 font-reckless text-[4rem] text-gold'>Premium medical care and the feeling of Home.</h1>
        <div>
