        ...
        <div className='form flex-1 px-4 lg:px-0 ml-auto mr-auto max-w-lg justify-center font-sans text-gold font-medium'>
            ...
            <form onSubmit={onSubmit} className=' grid grid-cols-1 lg:grid-cols-2 lg:gap-2 gap-y-2 grid-rows-1'>
                <div className='col-span-1 col-start-1'>
                    <label>
                        <input  required placeholder='Name' value={toSend.from_name} name='from_name' onChange={handleChange} className=" border-2 px-4 border-[#2b5c44] w-full placeholder:text-gold placeholder:opacity-40 h-12 rounded-lg focus:border-green-400 bg-transparent" type="text" />
                    </label>
                </div>
                ...
                <div className='lg:col-span-2 col-start-1  col-span-1'>
                    <label>
                        <input required placeholder='Phone' value={toSend.phone} name='phone' onChange={handleChange} className="border-2 px-4 w-full border-[#2b5c44] placeholder:text-gold placeholder:opacity-40 h-12 rounded-lg focus:border-green-400 bg-transparent" type="phone" />
                    </label>
                </div>

                <div className='lg:col-span-2 col-span-1 col-start-1'>
                    <label>
                        <textarea style={{resize:'none'}} required placeholder='Message' value={toSend.message} name='message' onChange={handleChange} className=" w-full border-2 px-4  border-[#2b5c44] placeholder:text-gold placeholder:opacity-40 h-32 rounded-lg focus:border-green-400 bg-transparent" type="text" />
                    </label>
                </div>
                ...
                <div className='col-start-1 col-span-2'>
                    <label className='flex items-center space-x-5'>
                        ...
                        <p>I agree with the GPDR policy and with processing my own data.</p>
                    </label>
                </div>
